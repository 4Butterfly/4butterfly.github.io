        ...
        _initSelector: function() {
            ...
            for(var i = 0; i < this.data.length; i++) {
                ...
                var option = $('<div data-phone="'+
                    ...
                    ' class="country-phone-option"><span>+'+ country.ph +'<img src="assets/jobs/blank.gif" class="flag flag-'+
                    country.co +
                    '"></span>'+ country.na +'</div>'
                );
            ...
            if(selected) {
                this.container.find('.country-phone-selected')
                    .html('<img src="assets/jobs/blank.gif" class="flag flag-'+ selected.co +'">+'+ selected.ph);
            }
